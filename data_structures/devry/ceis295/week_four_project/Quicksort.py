class Quicksort:
    ...
    and elements larger than the pivot are placed after it.\n
    It recursively applies this process to the sub-arrays until\n
    the array is sorted.\n
    Time Complexity:
    ...
    Space Complexity:
        ...
        Worst Case: O(n) - due to the recursion stack space\n
    """
    @classmethod
    def sort(cls, list):
